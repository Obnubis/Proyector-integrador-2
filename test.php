...
<html lang="en">
  ...
  <body>
     ...
     <form action="" method="post">
      ...
      include "header.php";
      ?>
      <div class="box-3"><span class="text-6">TEST TDA</span></div>
      <div class="wrapper-3">
        <div class="wrapper-4">
          <span class="text-7"
        ...
        <div class="img"><img src="img/image 16.png"  max-width: 100%; height: auto; alt=""></div>
        <div class="pic-3"><img src="img/image 17.png"  max-width: 100%; height: auto; alt=""></div>
        <div class="pic-4"><img src="img/image 18.png"   max-width: 100%; height: auto; alt=""></div>
        <div class="img-2"><img src="img/image 19.png"  max-width: 100%; height: auto; alt=""></div>
      </div>
      <?php
      include "footer.php";
      ?>
